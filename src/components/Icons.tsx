...
export const MailIcon = ({ className = "", size = 18 }: IconProps) => (
  <svg aria-hidden="true" focusable="false" width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
export const HomeIcon = ({ className = "", size = 18 }: IconProps) => (
  <svg aria-hidden="true" focusable="false" width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
